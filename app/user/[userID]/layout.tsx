    ...
    <div className='w-[95%] h-[98%] flex items-center justify-start shadow-lg rounded-3xl'>
      {/* Left Section */}
        <div className='md:w-full md:max-w-40 w-16 md:h-[95%] h-[50%] border-r-[1px] border-solid border-slate-300 flex flex-col items-center justify-center'>
          <div className='px-2 py-4 flex flex-col items-start justify-between gap-4'>
            <Link 
              className={`p-2 rounded-xl flex items-center justify-start gap-4 border-solid border-2 hover:border-black  ${pageSettings.currentMenu === 'overview' ? "bg-black text-white border-black" : "bg-white text-black border-white"}`}
              href={`/user/${userID}/`}
            >
              <Eye/>
            ...
            <Link 
              className={`p-2 rounded-xl flex items-center justify-start gap-4 border-solid border-2 hover:border-black  ${pageSettings.currentMenu === 'account' ? "bg-black text-white border-black" : "bg-white text-black border-white"}`}
            ...
            <Link 
              className={`p-2 rounded-xl flex items-center justify-start gap-4 border-solid border-2 hover:border-black  ${pageSettings.currentMenu === 'orders' ? "bg-black text-white border-black" : "bg-white text-black border-white"}`}
            ...
            <Link 
              className={`p-2 rounded-xl flex items-center justify-start gap-4 border-solid border-2 hover:border-black  ${pageSettings.currentMenu === 'payments' ? "bg-black text-white border-black" : "bg-white text-black border-white"}`}
            ...
            <Link 
              className={`p-2 rounded-xl flex items-center justify-start gap-4 border-solid border-2 hover:border-black  ${pageSettings.currentMenu === 'addresses' ? "bg-black text-white border-black" : "bg-white text-black border-white"}`}
